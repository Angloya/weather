...
<div class="main">
  <div class="right">
    ...
    <london3hr class="city"/>
    </div>
    <div class="left">
    <london5day v-show="show" class="city"/>
    </div>
  </div>
  </template>
...
<script>
// @ is an alias to /src
import london3hr from '@/components/3hr/London3hr.vue'
import london5day from '@/components/5day/London5day.vue'
export default {
  name: 'London',
  components: {
    london3hr,
