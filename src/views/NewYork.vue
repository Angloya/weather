...
<div class="main">
  <div class="right">
    ...
    <newYork3hr class="city"/>
    </div>
    <div class="left">
    <newYork5day v-show="show" class="city"/>
    </div>
  </div>
  </template>
...
<script>
// @ is an alias to /src
import newYork3hr from '@/components/3hr/NewYork3hr.vue'
import newYork5day from '@/components/5day/NewYork5day.vue'
export default {
  name: 'NewYork',
  components: {
    newYork3hr,
